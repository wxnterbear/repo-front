...
const ProposalsForms = () => {
    ...
    const handleFilesChange = (e) => setFiles(e.target.value);
                ...
                <div className="form-container">
                    ...
                    <div className="pb-container">
                        ...
                        <select value={proposedBy} onChange={handleProposedByChange} required>
                            <option value="">---------</option>
                            <option value="1">salomon.ruizn</option>
                            <option value="2">salo</option>
                            <option value="3">enefectoootracuenta</option>
                        </select>
                    </div>
